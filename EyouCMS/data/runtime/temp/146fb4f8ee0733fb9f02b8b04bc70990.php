<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:27:"./template/pc/lists_law.htm";i:1557482133;s:57:"/home/o2design/public_html/EyouCMS/template/pc/header.htm";i:1557303003;s:57:"/home/o2design/public_html/EyouCMS/template/pc/footer.htm";i:1557302387;}*/ ?>
<!DOCTYPE HTML>
		...
		<div class="main_wrap">
				...
				<div class="searchBox">
					...
					<form class="sidebar-search" method="get" action="<?php echo $field['action']; ?>">
						...
						<div class="form-group">
							...
							<button type="submit" class="input-search-btn"><i class="fas fa-search"></i></button>
						</div>
					</form>
					<?php ++$e; endforeach;endif; else: echo htmlspecialchars_decode("");endif; ?>
				</div>
			...
			<ul class="lawInfoList">
        		...
        		<li>
        			...
        			<div class="lawTitle"><a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"><?php echo $field['title']; ?></a></div>
          		</li>
