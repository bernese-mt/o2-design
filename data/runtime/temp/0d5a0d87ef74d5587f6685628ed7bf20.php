<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/product/add.htm";i:1558672259;s:71:"/home/o2design/public_html/application/admin/template/public/layout.htm";i:1558672259;s:76:"/home/o2design/public_html/application/admin/template/field/addonextitem.htm";i:1558667875;s:71:"/home/o2design/public_html/application/admin/template/public/footer.htm";i:1558667897;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Product/add'); ?>" method="post">
        ...
        <div class="ncap-form-default tab_div_1">
            ...
            <!-- 产品价格属性 -->
            <?php if(empty($ShopType) || (($ShopType instanceof \think\Collection || $ShopType instanceof \think\Paginator ) && $ShopType->isEmpty())): ?>
                <input type="hidden" name="prom_type" value="0"/>
            <?php endif; if($ShopType == '1'): ?>
                <input type="hidden" name="prom_type" value="1"/>
            <?php endif; if($ShopType == '2'): ?>
                <dl class="row">
                    <dt class="tit">
