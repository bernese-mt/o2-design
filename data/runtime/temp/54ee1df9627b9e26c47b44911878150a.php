<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./application/admin/template/archives\release.htm";i:1559289731;s:66:"D:\site\ada\o2-design\application\admin\template\public\layout.htm";i:1558672259;s:66:"D:\site\ada\o2-design\application\admin\template\public\footer.htm";i:1558667897;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page ksedit">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><i class="fa fa-edit"></i>快捷發布</h3>
                <h5></h5>
            </div>
        </div>
    </div>
    <form class="form-horizontal" id="post_form" action="<?php echo url('Archives/release'); ?>" method="post">
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="title"><em>*</em>發布至</label>
                </dt>
                <dd class="opt">
...
<script type="text/javascript">
    ...
    function check_submit(){
        ...
        if ($.inArray(current_channel, js_allow_channel_arr) == -1) {
            layer.alert('該欄目模型不允許發布文檔！', {icon:5, title:false}, function(index){
                $('#typeid').val('');
                layer.close(index);
            });
            return false;
