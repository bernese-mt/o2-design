<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/view_article.htm";i:1557461221;s:57:"/home/o2design/public_html/EyouCMS/template/pc/header.htm";i:1557303003;s:57:"/home/o2design/public_html/EyouCMS/template/pc/footer.htm";i:1557302387;}*/ ?>
<!DOCTYPE HTML>
...
<link rel="stylesheet" type="text/css" href="template/pc/css/news.css">
 ...
 <body> 
	...
	<nav class="manu_box navbar navbar-default navbar-mobile bootsnav">
		...
		<div class="main_wrap">
			...
			<!--bread end-->
			<div class="newsDate">
				<div class="newsSort"><?php echo $eyou['field']['typename']; ?> - </div>
				<div class="dateBox"><?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?></div>
			</div>
			<h1 class="newsTitle"><?php echo $eyou['field']['title']; ?></h1>
			<div class="share">
				<b>Share：</b>
