<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:26:"./template/pc/view_law.htm";i:1557499632;s:57:"/home/o2design/public_html/EyouCMS/template/pc/header.htm";i:1557303003;s:57:"/home/o2design/public_html/EyouCMS/template/pc/footer.htm";i:1557302387;}*/ ?>
<!DOCTYPE HTML>
...
<link rel="stylesheet" type="text/css" href="template/pc/css/law.css">
 ...
 <body> 
	...
	<nav class="manu_box navbar navbar-default navbar-mobile bootsnav">
		...
		<div class="main_wrap">
			...
			<!--bread end-->
			<div class="lawDate">
				<div class="lawSort"><?php echo $eyou['field']['typename']; ?> - </div>
				<div class="dateBox"><?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?></div>
			</div>
			<h1 class="lawTitle"><?php echo $eyou['field']['title']; ?></h1>
			<div class="functionBox">
				<div class="citationsBox">文章引用自：<a href="<?php echo $eyou['field']['citations_link']; ?>" target="_blank"><?php echo $eyou['field']['article_citations']; ?></a></div>
				<div class="share">
					<b>Share：</b>
			...
			<div class="main_article">
				<?php echo $eyou['field']['law_content']; ?>
			</div>
			<div class="pageNav">
				<ul>
					<li class="prev">
