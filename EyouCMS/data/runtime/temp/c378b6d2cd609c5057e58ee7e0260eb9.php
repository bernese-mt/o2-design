<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"./template/pc/lists_lecture.htm";i:1557477736;s:57:"/home/o2design/public_html/EyouCMS/template/pc/header.htm";i:1557303003;s:57:"/home/o2design/public_html/EyouCMS/template/pc/footer.htm";i:1557302387;}*/ ?>
<!DOCTYPE HTML>
...
<link rel="stylesheet" type="text/css" href="template/pc/css/lecture.css">
		...
		<div class="main_wrap">
			...
			<div class="lectureInfoList">
				<?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 10, "", "", "desc");if(is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$field["title"] = text_msubstr($field["title"], 0, 30, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$mod = ($e % 2 );$i= intval($key) + 1;?>
       			<h3><em><i class="fas fa-plus"></i></em><?php echo $field['title']; ?></h3>
        		<ul>
        			<li class="askBox">
        				<div class="titleBox" data-num="Q">
        					<span>Ask questions</span>
        					<p><?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("from_ask", $field['aid']); echo $__VALUE__; ?></p>
        				</div>
        				<div class="questions_content"><?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("questions", $field['aid']); echo $__VALUE__; ?></div>
					</li>
       				<li class="replyBox">
        				<div class="titleBox" data-num="A">
        					<span>Respondent</span>
        					<p><?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("respondent", $field['aid']); echo $__VALUE__; ?></p>
        				</div>
        				<div class="reply_content"><?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("reply_content", $field['aid']); echo $__VALUE__; ?></div>
        			</li>
        			<li class="provisionsBox">
        				<div class="titleBox" data-num="Legal">
        					<span>Legal provisions</span>
        					<p>法律小講堂</p>
        				</div>
        				<div class="legal_content">
       						<h4><?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("citation_clause", $field['aid']); echo $__VALUE__; ?></h4>
       						<div class="legal_article"><?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("quoted_text", $field['aid']); echo $__VALUE__; ?></div>
						</div>
        			</li>
          		</ul>
...
<script type="text/javascript" src="template/pc/Scripts/SuperSlide/jquery.SuperSlide.min.js"></script>
<script type="text/javascript">
	$(document).ready(function() {
		$('.lectureInfoList').slide({
			titCell:"h3", 
			targetCell:"ul",
			defaultIndex:1,
			effect:"slideDown",
