<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/lists_course.htm";i:1557466694;s:57:"/home/o2design/public_html/EyouCMS/template/pc/header.htm";i:1557303003;s:57:"/home/o2design/public_html/EyouCMS/template/pc/footer.htm";i:1557302387;}*/ ?>
<!DOCTYPE HTML>
	...
	<nav class="manu_box navbar navbar-default navbar-mobile bootsnav">
		...
		<div class="main_wrap">
			...
			<ul class="courseInfoList">
        		...
        		<li>
        			<div class="Class_date"><i class="far fa-calendar-alt"></i> <?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("Class_date", $field['aid']); echo $__VALUE__; ?> <span><?php  $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("Registration_status", $field['aid']); echo $__VALUE__; ?></span></div>
        			<div class="item">
        				<div class="courseSort"><?php echo $field['typename']; ?></div>
          				<div class="courseTitle"><a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"><?php echo $field['title']; ?></a></div>
          			</div>
