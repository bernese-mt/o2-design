		...
		<div class="layui-layout layui-layout-admin">
			<div class="layui-header">
				...
				<ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
					...
					<li class="layui-nav-item layui-hide-xs" lay-unselect>
						<a href="javascript:;"> <cite><?php echo $config['title'];?></cite></a>
					...
					<li class="layui-nav-item layui-hide-xs" lay-unselect>
						<a href="javascript:$.admin_index.site();void(0);" title="<?php echo P_Lang("添加新站点");?>"><i class="layui-icon layui-icon-add-1"></i> <?php echo P_Lang("添加站点");?></a>
					</li>
					<?php } ?>
					<?php if($sys['multiple_language'] && $langlist){ ?>
					<li class="layui-nav-item" lay-unselect>
						<a href="javascript:;"><cite id="lang_title"><?php echo $language;?></cite></a>
					...
					<?php } ?>
					<li class="layui-nav-item" lay-unselect>
						<a href="javascript:;"> <cite><?php if($session['admin_rs'] && $session['admin_rs']['fullname']){ ?><?php echo $session['admin_rs']['fullname'];?><?php } else { ?><?php echo $session['admin_account'];?><?php } ?></cite></a>
						<dl class="layui-nav-child">
							<dd><a href="javascript:$.admin_index.me();void(0);">基本资料</a></dd>
							<dd><a href="javascript:$.admin_index.pass();void(0);">修改密码</a></dd>
							<?php if(!$sys['develop'] && $session['admin_rs']['if_system']){ ?>
								<?php if($session['adm_develop']){ ?>
								<dd><a href="javascript:$.admin_index.develop(0);void(0);">应用模式</a></dd>
								<?php } else { ?>
								<dd><a href="javascript:$.admin_index.develop(1);void(0);">开发模式</a></dd>
								<?php } ?>
							<?php } ?>
					...
					<ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
			            ...
			            <li data-name="list" class="layui-nav-item">
			              ...
			              <dl class="layui-nav-child">
								...
								<dd pid="<?php echo $value['id'];?>" data-name="project_<?php echo $value['id'];?>"> <a lay-href="<?php echo $value['url'];?>" lay-text="<?php echo $value['title'];?>"><?php echo $value['nick_title'] ? $value['nick_title'] : $value['title'];?></a></dd>
								<?php } ?>
						  </dl>
			            </li>
			            <?php } ?>
