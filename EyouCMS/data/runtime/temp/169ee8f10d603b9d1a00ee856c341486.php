<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/admin/template/contact/edit.htm";i:1557638124;s:79:"/home/o2design/public_html/EyouCMS/application/admin/template/public/layout.htm";i:1557218894;s:82:"/home/o2design/public_html/EyouCMS/application/admin/template/field/modelfield.htm";i:1557218875;s:79:"/home/o2design/public_html/EyouCMS/application/admin/template/public/footer.htm";i:1557218894;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Contact/edit'); ?>" method="post">
        <!-- 常规信息 -->
        <div class="ncap-form-default tab_div_1">
            ...
            <?php endif; if(is_array($addonFieldExtList) || $addonFieldExtList instanceof \think\Collection || $addonFieldExtList instanceof \think\Paginator): $i = 0; $__LIST__ = $addonFieldExtList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(isset($vo['ifeditable']) && $vo['ifeditable'] == 1): switch($vo['dtype']): case "hidden": ?>
                <!-- 隐藏域 start -->
