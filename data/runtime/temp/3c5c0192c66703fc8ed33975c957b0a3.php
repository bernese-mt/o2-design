<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"./application/admin/template/admin\admin_add.htm";i:1558667843;s:66:"D:\site\ada\o2-design\application\admin\template\public\layout.htm";i:1558672259;s:68:"D:\site\ada\o2-design\application\admin\template\admin\admin_bar.htm";i:1558667844;s:66:"D:\site\ada\o2-design\application\admin\template\public\footer.htm";i:1558667897;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--             <dl class="row">
                ...
                <dd class="opt">
                    <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" name="language[]" value="cn" class="none" />简体中文</label>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl> -->
            <dl class="row">
                ...
                <dd class="opt">
                    <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" name="online_update" value="1" class="none" />允许操作</label>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" name="only_oneself" value="1" class="none" />只允许查看自己发布的文档</label>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <p><label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" id="select_cud" class="none" />完全控制</label></p>
                    <p><label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" name="cud[]" value="add" class="none" />添加信息</label></p>
                    <p><label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" name="cud[]" value="edit" class="none" />修改信息</label></p>
                    <p><label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" name="cud[]" value="del" class="none" />删除信息</label></p>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <p>
                        <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" id="select_all_permission" class="none" />全部选择</label>
                    </p>
                            ...
                            <?php if(! empty($arctypes)): ?>
                                <p>
                                    <?php $first_arctype_id = ''; if(is_array($arctypes) || $arctypes instanceof \think\Collection || $arctypes instanceof \think\Paginator): if( count($arctypes)==0 ) : echo "" ;else: foreach($arctypes as $k=>$arctype): if(isset($arctype_array[$arctype['id']])): if($k>0): ?>
                                        ...
                                        <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" class="arctype_cbox arctype_id_<?php echo $arctype['id']; ?> none" name="permission[arctype][]" value="<?php echo $arctype['id']; ?>" /><?php echo $arctype['typename']; ?></label>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </p>
                                ...
                                <?php if(is_array($arctypes) || $arctypes instanceof \think\Collection || $arctypes instanceof \think\Paginator): if( count($arctypes)==0 ) : echo "" ;else: foreach($arctypes as $k=>$arctype): if(isset($arctype_array[$arctype['id']])): ?>
                                    ...
                                    <?php foreach($arctype_array[$arctype['id']] as $item): ?>
                                        <div class="arctype_child1">
                                            <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" class="arctype_cbox arctype_id_<?php echo $item['id']; ?> none" name="permission[arctype][]" value="<?php echo $item['id']; ?>" data-pid="<?php echo $item['parent_id']; ?>" /><?php echo $item['typename']; ?></label>
                                        </div>
                                        ...
                                        <div class="arctype_child2" id="arctype_child_<?php echo $item['id']; ?>">
                                            ...
                                            <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" class="arctype_cbox none" data-pid="<?php echo $vo['parent_id']; ?>" data-tpid="<?php echo $item['parent_id']; ?>" name="permission[arctype][]" value="<?php echo $vo['id']; ?>" /><?php echo $vo['typename']; ?></label>
                                            <?php endforeach; ?>
                                        </div>
                          ...
                          <?php else: ?>
                            <div class="admin_poplistdiv">
                                ...
                                <p>
                                    ...
                                    <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" class="none" name="permission[rules][]" value="<?php echo $rule['id']; ?>" /><?php echo $rule['name']; ?></label>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </p>
                            </div>
                    ...
                    <div class="admin_poplistdiv">
                        ...
                        <ul>
                            ...
                            <li>
                                <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" class="none" name="permission[plugins][<?php echo $plugin['code']; ?>][code]" value="<?php echo $plugin['code']; ?>" /><?php echo $plugin['name']; ?></label>
                                <?php $config = json_decode($plugin['config'], true); if(! empty($config['permission'])): ?>
                                <p style="padding-left:10px;">
                                    <span class="button level1 switch center_docu"></span>
                                    <?php foreach($config['permission'] as $index => $text): ?>
                                    <label><img class="cboximg" src="/o2-design/public/static/admin/images/ok.png" /><input type="checkbox" class="none" name="permission[plugins][<?php echo $plugin['code']; ?>][child][]" value="<?php echo $index; ?>" /><?php echo $text; ?></label>
                                    <?php endforeach; ?>
                                </p>
                                <?php endif; ?>
                            </li>
...
<script type="text/javascript">
    $(function(){
        ...
        if (-1 == $('#postForm input[name="role_id"]').val()) {
            ...
            $('#postForm img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
        }
        /*--end*/
        ...
        $('.arctype_cbox').bind('click', function(){
            ...
            if($(this).attr('checked')){
                if (0 < $('input[data-pid="'+pid+'"]:checked').length) {
                    ...
                    $('.arctype_id_'+pid).parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                }
                if (0 < $('#arctype_child_'+tpid).find('input[type="checkbox"]:checked').length) {
                    $('.arctype_id_'+tpid).attr('checked', 'checked');
                    $('.arctype_id_'+tpid).parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                }
                $('#'+input).find('input[type="checkbox"]').attr('checked', 'checked');
                $('#'+input).find('input[type="checkbox"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
            }else{
                if (1 > $('input[data-pid="'+pid+'"]:checked').length) {
                    $('.arctype_id_'+pid).removeAttr('checked');
                    $('.arctype_id_'+pid).parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/del.png');
                }
                if (1 > $('#arctype_child_'+tpid).find('input[type="checkbox"]:checked').length) {
                    $('.arctype_id_'+tpid).removeAttr('checked');
                    $('.arctype_id_'+tpid).parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/del.png');
                }
                $('#'+input).find('input[type="checkbox"]').removeAttr('checked');
                $('#'+input).find('input[type="checkbox"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/del.png');
            }
        });
        $('#select_cud').bind('click', function(){
            if($(this).attr('checked')){
                $('#postForm input[name^="cud"]').attr('checked', 'checked');
                $('#postForm input[name^="cud"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
            }else{
                $('#postForm input[name^="cud"]').removeAttr('checked');
                $('#postForm input[name^="cud"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/del.png');
            }
        });
        ...
        $('#select_all_permission').bind('click', function(){
            if($(this).attr('checked')){
                ...
                $('#postForm input[name^="permission"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
            }else{
                $('#postForm input[name^="permission"]').removeAttr('checked');
                $('#postForm input[name^="permission"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/del.png');
            }
        });
    ...
    function hasSelectAll(){
        ...
        if(c){
            ...
            $('#select_all_permission').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
        }else{
            $('#select_all_permission').removeAttr('checked');
            $('#select_all_permission').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/del.png');
        }
        ...
        if(c1){
            ...
            $('#select_cud').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
        }else{
            $('#select_cud').removeAttr('checked');
            $('#select_cud').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/del.png');
        }
    }
    ...
    function changeRole(value){
        ...
        $('#postForm img.cboximg').attr('src', '/o2-design/public/static/admin/images/del.png');
            ...
            if(item.id == value){
                if(item.language){
                    item.language.map(function(row){
                        ...
                        $('#postForm input[name^="language"][value="'+row+'"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                    });
                }

                if(item.online_update){
                    $('#postForm input[name="online_update"]').attr('checked', 'checked');
                    $('#postForm input[name="online_update"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                };
                // if(item.editor_visual){
                //     $('#postForm input[name="editor_visual"]').attr('checked', 'checked');
                //     $('#postForm input[name="editor_visual"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                // };
                if(item.only_oneself){
                    $('#postForm input[name="only_oneself"]').attr('checked', 'checked');
                    $('#postForm input[name="only_oneself"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                };
                if(item.cud){
                    item.cud.map(function(row){
                        $('#postForm input[name^="cud"][value="'+row+'"]').attr('checked', 'checked');
                        $('#postForm input[name^="cud"][value="'+row+'"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                    });
                }
                        ...
                        if(p == 'plugins'){
                            if(item.permission[p]){
                                for(var pluginId in item.permission[p]){
                                    ...
                                    $('#postForm input[name="permission['+p+']['+pluginId+'][code]"][value="'+pluginId+'"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                                    if(item.permission[p][pluginId].child){
                                        item.permission[p][pluginId].child.map(function(row){
                                            ...
                                            $('#postForm input[name="permission['+p+']['+pluginId+'][child][]"][value="'+row+'"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                                        });
                                    }
                                }
                            }
                            ...
                            item.permission[p].map(function(row){
                                ...
                                $('#postForm input[name="permission['+p+'][]"][value="'+row+'"]').parent().find('img.cboximg').attr('src', '/o2-design/public/static/admin/images/ok.png');
                            });
                        }
