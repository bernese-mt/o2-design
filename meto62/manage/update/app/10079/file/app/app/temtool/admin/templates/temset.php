...
<form method="POST" name="myform" class="ui-from" action="{$_M['url']['own_form']}a=dosetsave&no={$_M['form']['no']}&pos={$_M['form']['pos']}" target="_self">
	<div class="v52fmbx temset">
		...
		<table class="display dataTable ui-table" data-table-ajaxurl="{$_M['url']['own_form']}a=dotable_temset_json&no={$_M['form']['no']}&pos={$_M['form']['pos']}" data-table-pageLength='1000'>
			<thead>
				<tr>
