<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"./template/pc/view_images.htm";i:1557902340;s:57:"/home/o2design/public_html/EyouCMS/template/pc/header.htm";i:1557303003;s:57:"/home/o2design/public_html/EyouCMS/template/pc/footer.htm";i:1557302387;}*/ ?>
<!DOCTYPE HTML>
 ...
 <body>
	...
	<nav class="manu_box navbar navbar-default navbar-mobile bootsnav">
		...
		<div class="main_wrap">
			...
			<h1 class="albumTitle"><?php echo $eyou['field']['title']; ?></h1>
			<div class="share">
				<b>Share：</b>
			...
			<ul class="main_album">
        		...
        		<li>
        			<a class="album" data-fancybox-group="gallery" href="<?php echo $field['image_url']; ?>" title="活動日期：<?php echo $eyou['field']['event_date']; ?><br >活動地點：<?php echo $eyou['field']['event_location']; ?><br ><?php echo $eyou['field']['album_txt']; ?>"><img src="<?php echo $field['image_url']; ?>" alt="<?php echo $field['title']; ?>" /></a>
        		</li>
        		<?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; ?>
			</ul>
			<div class="pageNav">
...
<link rel="stylesheet" type="text/css" href="template/pc/Scripts/fancyBox/jquery.fancybox.css">
<script type="text/javascript" src="template/pc/Scripts/fancyBox/jquery.fancybox.js"></script>
