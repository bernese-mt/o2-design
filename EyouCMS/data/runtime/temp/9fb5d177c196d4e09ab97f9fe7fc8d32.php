<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/index/index.htm";i:1557218927;s:80:"/home/o2design/public_html/EyouCMS/application/admin/template/public/menubox.htm";i:1557218895;s:77:"/home/o2design/public_html/EyouCMS/application/admin/template/public/left.htm";i:1557218895;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="eycms_cont_left hidden-xs">
    ...
    <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['is_menu'] == '1'): ?>
        <dl>
            ...
            <dd class="sub-menu">
              <?php if(is_array($vo['child']) || $vo['child'] instanceof \think\Collection || $vo['child'] instanceof \think\Paginator): $k2 = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($k2 % 2 );++$k2;if($v2['is_menu'] == 1 AND (!empty($v2['controller']) OR !empty($v2['url']) OR !empty($vo2['child']))): if(empty($v2['child']) || (($v2['child'] instanceof \think\Collection || $v2['child'] instanceof \think\Paginator ) && $v2['child']->isEmpty())): ?>
                    ...
                    <dl class="jslist" style="border-bottom:none;">
                        ...
                        <dd style="display: none;">
                            <?php if(is_array($v2['child']) || $v2['child'] instanceof \think\Collection || $v2['child'] instanceof \think\Paginator): $k3 = 0; $__LIST__ = $v2['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v3): $mod = ($k3 % 2 );++$k3;if($v3['is_menu'] == 1 AND (!empty($v3['controller']) OR !empty($v3['url']) OR !empty($v3['child']))): ?>
