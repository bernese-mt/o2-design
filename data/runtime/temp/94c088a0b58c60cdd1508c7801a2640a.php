<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"./application/admin/template/field/channel_index.htm";i:1558672259;s:71:"/home/o2design/public_html/application/admin/template/public/layout.htm";i:1558672259;s:75:"/home/o2design/public_html/application/admin/template/field/channel_bar.htm";i:1558667878;s:71:"/home/o2design/public_html/application/admin/template/public/footer.htm";i:1558667897;}*/ ?>
<!doctype html>
<html>
<head>
                        ...
                        <tr>
                            ...
                            <td class="">
                                ...
                                <?php else: if(is_check_access(CONTROLLER_NAME.'@channel_edit') == '1'): ?>
                                    ...
                                    <?php endif; endif; ?>
                                <a class="btn blue" href="javascript:void(0);" data-name="<?php echo $vo['name']; ?>" data-channel_id="<?php echo (isset($channel_id) && ($channel_id !== '')?$channel_id:'0'); ?>" data-dtype="<?php echo $vo['dtype']; ?>" onclick="copyToClipBoard(this)">标签调用</a>
                                </div>
                            </td>
                            <td class="sort">
                                <div class="w60 tc">
