<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/lists_search.htm";i:1557500520;s:57:"/home/o2design/public_html/EyouCMS/template/pc/header.htm";i:1557303003;s:57:"/home/o2design/public_html/EyouCMS/template/pc/footer.htm";i:1557302387;}*/ ?>
<!DOCTYPE HTML>
...
<link rel="stylesheet" type="text/css" href="template/pc/css/search.css">
...
<body>
	...
	<nav class="manu_box navbar navbar-default navbar-mobile bootsnav">
		...
		<!--mainBox-->
		<div class="main_wrap">
			<h1 class="searchTitle"><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:4:"sys7";}'); echo $__VALUE__; ?> <strong><?php echo $eyou['field']['keywords']; ?></strong> <?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:6:"yybl12";}'); echo $__VALUE__; ?></h1>
			<ul class="searchList">
				...
				<li>
					<div class="item">
						...
						<div class="searchTitle"><a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>" target="_self"><?php echo $field['title']; ?></a></div>
					</div>
					<p class="ellipsis"><?php echo $field['seo_description']; ?></p>
				</li>
