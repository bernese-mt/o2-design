<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:23:"./template/pc/index.htm";i:1559276415;s:44:"D:\site\ada\o2-design\template\pc\header.htm";i:1559270893;s:44:"D:\site\ada\o2-design\template\pc\footer.htm";i:1559113908;}*/ ?>
<!DOCTYPE HTML>
		...
		<nav class="navbar navbar-default navbar-mobile bootsnav">
	        ...
	        <div class="collapse navbar-collapse" id="navbar-menu">
	        	<ul class="nav navbar-nav" data-in="fadeInDown" data-out="fadeOutUp">
            		...
            		<li class="dropdown">
            			<a href="<?php echo $field['typeurl']; ?>" class="dropdown-toggle <?php echo $field['currentstyle']; ?>" <?php if(!(empty($field['children']) || (($field['children'] instanceof \think\Collection || $field['children'] instanceof \think\Paginator ) && $field['children']->isEmpty()))): ?>data-toggle="dropdown"<?php endif; ?>>
                            <span data-title="<?php echo $field['typename']; ?>"><?php echo $field['typename']; ?></span>
                            <?php if(!(empty($field['children']) || (($field['children'] instanceof \think\Collection || $field['children'] instanceof \think\Paginator ) && $field['children']->isEmpty()))): ?>
                            <i class="fas fa-angle-right"></i><?php endif; ?>
                        </a>
            			<?php if(!(empty($field['children']) || (($field['children'] instanceof \think\Collection || $field['children'] instanceof \think\Paginator ) && $field['children']->isEmpty()))): ?>
	...
	<script type="text/javascript">
		$(function(){
			...
			$(window).scroll(function(){
				...
				var divTop = $('.countArea').offset().top;
				var divHeight = $('.countArea').height();
				var winHeight = $(window).height();
				console.log(fromTop);
				console.log(divTop);
				console.log(divHeight);
				console.log(winHeight);
				if (100 == divTop - fromTop) {
					//alert('123');
					$('.num-year').animateNumber({ number: 15 });
					$('.num-people').animateNumber({ number: 7 });
					$('.num-program').animateNumber({ number: 10 });
					$('.num-web').animateNumber({ number: 156 });
					$('.num-case').animateNumber({ number: 2000 });
				}
			});
		});
	</script>
