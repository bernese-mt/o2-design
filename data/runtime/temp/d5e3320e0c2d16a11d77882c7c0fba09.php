...
<head>
    ...
    <link rel="stylesheet" href="/o2-design/public/plugins/ztree/css/zTreeStyle/zTreeStyle.css?v=<?php echo $version; ?>" type="text/css">
    <script type="text/javascript" src="/o2-design/public/static/admin/js/jquery.js"></script>
    <!-- <script src="/o2-design/public/static/admin/js/jquery-ui/jquery-ui.min.js"></script> -->
    <script src="/o2-design/public/static/admin/js/jquery.layout-latest.min.js"></script>
    <script type="text/javascript" src="/o2-design/public/plugins/ztree/js/jquery.ztree.core.min.js"></script>
    <script type="text/javascript" src="/o2-design/public/plugins/layer-v3.1.0/layer.js"></script>
    <!--[if lt IE 9]>
    <script src="/o2-design/public/static/admin/js/html5shiv.js"></script>
    <script src="/o2-design/public/static/admin/js/respond.min.js"></script>
    <![endif]-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            /*  底部配置 */
            ,   south__spacing_open:        0       /* 底部邊框大小*/
            /*  some pane-size settings*/
            ,   west__minSize:              200     /*左側最小寬度*/
            ,   west__maxSize:              500     /*左側最大寬度*/
            /*  左側配置 */
            ...
            ,   stateManagement__enabled:   false   /*是否讀取cookies*/
...
<body>
    <div class="ui-layout-west">
        <h3><a href="javascript:void(0);" onclick="quick_release();"><i class="fa fa-edit"></i>快捷發布文章</a></h3>
