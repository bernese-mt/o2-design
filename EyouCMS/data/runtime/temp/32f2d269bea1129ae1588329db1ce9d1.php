<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/images/edit.htm";i:1557218823;s:79:"/home/o2design/public_html/EyouCMS/application/admin/template/public/layout.htm";i:1557218894;s:84:"/home/o2design/public_html/EyouCMS/application/admin/template/field/addonextitem.htm";i:1557218873;s:79:"/home/o2design/public_html/EyouCMS/application/admin/template/public/footer.htm";i:1557218894;}*/ ?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript">
    ...
    function ClearPicArr2(obj,path)
    {
        ...
        $.ajax({
            type:'GET',
            url:"<?php echo url('Images/del_imgupload'); ?>",
            data:{filename:path},
            success:function(){
                $(obj).parent().remove(); // 删除完服务器的, 再删除 html上的图片  
                $.ajax({
