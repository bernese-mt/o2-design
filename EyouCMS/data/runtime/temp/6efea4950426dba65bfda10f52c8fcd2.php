<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./application/admin/template/contact/index.htm";i:1557638124;s:79:"/home/o2design/public_html/EyouCMS/application/admin/template/public/layout.htm";i:1557218894;s:83:"/home/o2design/public_html/EyouCMS/application/admin/template/archives/tags_btn.htm";i:1557218860;s:79:"/home/o2design/public_html/EyouCMS/application/admin/template/public/footer.htm";i:1557218894;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" action="<?php echo url('Contact/index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2">
                        <input type="button" class="btn" value="重置" onClick="window.location.href='<?php echo url('Contact/index', array("typeid"=>\think\Request::instance()->param('typeid'))); ?>';">
                    </div>
                </div>
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="" style="width: 100%;">
                                <div class="tl" style="padding-left: 10px;">
                                    ...
                                    <a href="<?php echo url('Contact/edit',array('id'=>$vo['aid'])); ?>" style="<?php if($vo['is_b'] == '1'): ?> font-weight: bold;<?php endif; ?>"><?php echo $vo['title']; ?></a>
                                    <?php else: ?>
                                    <?php echo $vo['title']; endif; ?>
                                </div>
                            </td>
                            <td class="">
                                <div class="w100 tc"><a href="<?php echo url('Contact/index', array('typeid'=>$vo['typeid'], 'tab'=>3)); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td>
                                <div class="tc w50">
                            ...
                            <td class="">
                                <div class="w180 tc">
                                    ...
                                    <a href="<?php echo url('Contact/edit',array('id'=>$vo['aid'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Contact/del'); ?>" data-id="<?php echo $vo['aid']; ?>" data-deltype="pseudo" onClick="delfun(this);"><i class="fa fa-trash-o"></i>删除</a>
                                    <?php endif; ?>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a onclick="batch_del(this, 'ids');" data-url="<?php echo url('Contact/del'); ?>" data-deltype="pseudo">
                ...
                <div class="fbutton">
                    <a href="<?php echo url('Contact/add', array('typeid'=>\think\Request::instance()->param('typeid'))); ?>">
                        <div class="add" title="新增数据">
                            <span class="red"><i class="fa fa-plus"></i>新增数据</span>
                        </div>
                    </a>
                </div>
                <?php endif; ?>
