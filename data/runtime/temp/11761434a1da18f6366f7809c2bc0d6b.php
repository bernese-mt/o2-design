<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/template/admin\login.htm";i:1558672259;s:66:"D:\site\ada\o2-design\application\admin\template\public\footer.htm";i:1558667897;}*/ ?>
<!DOCTYPE html>
...
<html>
    <head>
        ...
        <link href="/o2-design/public/static/admin/css/login.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript" src="/o2-design/public/static/admin/js/jquery.js"></script>
        <script type="text/javascript" src="/o2-design/public/static/admin/js/jquery.SuperSlide.2.1.2.js"></script>
    ...
    <body>
        ...
        <div class="container">
            <div class="logo">
                ...
                <img src="/o2-design/public/static/admin/images/logo_ey.png?v=<?php echo time(); ?>">
                <?php else: ?>
                <img src="/o2-design/public/static/admin/images/logo.png?v=<?php echo time(); ?>">
                <?php endif; ?>
            </div>
            <div class="box">
