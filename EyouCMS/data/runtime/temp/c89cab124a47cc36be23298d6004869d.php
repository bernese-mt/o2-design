<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/admin/template/uploadify/upload.htm";i:1557218923;}*/ ?>
<html lang="zh-cn">
<head>
<meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
<title>文件管理</title>
<link rel="stylesheet" type="text/css" href="/EyouCMS/public/plugins/webuploader/webuploader.css?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>">
<link rel="stylesheet" type="text/css" href="/EyouCMS/public/plugins/webuploader/css/style.css?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>">
...
<script type="text/javascript" src="/EyouCMS/public/plugins/webuploader/webuploader.min.js?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>"></script>
<script type="text/javascript" src="/EyouCMS/public/plugins/webuploader/upload.js?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>"></script>
<script type="text/javascript" src="/EyouCMS/public/plugins/layer-v3.1.0/layer.js?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>"></script>
<script type="text/javascript">
$(function(){
    var config = {
