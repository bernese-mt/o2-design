<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"./application/admin/template/uploadify\upload_full.htm";i:1558672259;}*/ ?>
<html lang="zh-cn">
<head>
<meta http-equiv="Content-Type" content="text/html;charset=UTF-8">
<title>文件管理</title>
<link rel="stylesheet" type="text/css" href="/o2-design/public/plugins/webuploader/webuploader.css?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>">
<link rel="stylesheet" type="text/css" href="/o2-design/public/plugins/webuploader/css/style.css?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>">
...
<script type="text/javascript" src="/o2-design/public/static/common/js/jquery.min.js"></script>
<script type="text/javascript" src="/o2-design/public/plugins/webuploader/webuploader.min.js?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>"></script>
<script type="text/javascript" src="/o2-design/public/plugins/webuploader/upload.js?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>"></script>
<script type="text/javascript" src="/o2-design/public/plugins/layer-v3.1.0/layer.js?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>"></script>
<script type="text/javascript">
$(function(){
    var config = {
            "swf":"/o2-design/public/plugins/webuploader/Uploader.swf",
