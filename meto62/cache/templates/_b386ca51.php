...
if($is_lte_ie9){
?>
<link href="<?php echo $url['site'];?>public/ui/v2/static/css/basic_admin-lteie9-1.css?<?php echo $basic_admin_css_filemtime_1;?>" rel="stylesheet" type="text/css">
<link href="<?php echo $url['site'];?>public/ui/v2/static/css/basic_admin-lteie9-2.css?<?php echo $basic_admin_css_filemtime_2;?>" rel="stylesheet" type="text/css">
<?php
}else{
?>
<link href="<?php echo $_M['url']['site'];?>public/ui/v2/static/css/basic_admin.css?<?php echo $basic_admin_css_filemtime;?>" rel='stylesheet' type='text/css'>
<?php
}
