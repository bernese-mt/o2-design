...
<div class="page" style="min-width:auto;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Contact/add'); ?>" method="post">
        <!-- 常规信息 -->
